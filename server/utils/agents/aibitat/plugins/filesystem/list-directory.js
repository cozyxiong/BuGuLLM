    ...
    return {
      ...
      setup(aibitat) {
        aibitat.function({
          ...
          name: this.name,
          description:
            "List files and folders in the knowledge vault (tree navigation). " +
            "Use first when exploring which topic folder to work in or before bulk organize. " +
            "Returns names with [FILE]/[DIR] prefixes — no file bodies. " +
          ...
          parameters: {
            ...
            properties: {
              path: {
                type: "string",
                description:
                  "Directory path relative to the vault root (use '.' for root). Do not use OS absolute paths.",
              },
              includeSizes: {
                type: "boolean",
                default: false,
