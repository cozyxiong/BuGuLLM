...
export default function WebsiteDepthOptions({ onImport, workspaceSlug: workspaceSlugProp }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { data, library, error } = await System.dataConnectors.websiteDepth.scrape({
        url: form.get("url"),
