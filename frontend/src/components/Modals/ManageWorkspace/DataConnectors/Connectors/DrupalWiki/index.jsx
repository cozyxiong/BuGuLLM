...
export default function DrupalWikiOptions({ onImport, workspaceSlug: workspaceSlugProp }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { data, library, error } = await System.dataConnectors.drupalwiki.collect({
      ...
      showToast(
        `Pages collected from Drupal Wiki spaces ${data.spaceIds}.${libraryMsg}`,
        "success",
        { clear: true }
      );
      e.target.reset();
