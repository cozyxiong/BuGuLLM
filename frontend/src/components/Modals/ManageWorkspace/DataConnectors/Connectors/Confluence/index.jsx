...
export default function ConfluenceOptions({ onImport, workspaceSlug: workspaceSlugProp }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { data, library, error } = await System.dataConnectors.confluence.collect({
      ...
      showToast(
        `Pages collected from Confluence space ${data.spaceKey}.${libraryMsg}`,
        "success",
        { clear: true }
      );
      e.target.reset();
