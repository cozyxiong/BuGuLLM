...
function TextSizeSubmenu({ selectedSize, onSizeChange }) {
  ...
  return (
    <div className="absolute right-full top-0 z-[70] mr-1">
      <div className="bg-zinc-800 light:bg-white border border-zinc-700/80 light:border-slate-200 rounded-2xl p-3.5 w-[98px] flex flex-col gap-1.5 shadow-[0_16px_48px_rgba(0,0,0,0.28)]">
