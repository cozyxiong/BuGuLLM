...
const TRANSLATIONS = {
  ...
  chat_window: {
    ...
    agent_activity: {
      ...
      loading: "正在生成",
      working: "處理中",
      used_tools: "執行了 {{count}} 個操作",
      expand: "展開",
      collapse: "收起",
    },
    agent_invocation: {
      model_wants_to_call: "模型請求呼叫",
      approve: "批准",
      reject: "拒絕",
      always_allow: "一律允許 {{skillName}}",
      tool_call_was_approved: "已批准工具呼叫",
      tool_call_was_rejected: "已拒絕工具呼叫",
      clarifying_skip: "由代理自行決定",
      clarifying_submit: "提交",
      clarifying_skipped: "已交由代理自行決定。",
      clarifying_timeout: "未在時限內提交回覆。",
      clarifying_pagination: "{{current}} / {{total}}",
      clarifying_prev_aria: "上一題",
      clarifying_next_aria: "下一題",
      clarifying_close_aria: "關閉並跳過",
      clarifying_other: "其他",
      clarifying_other_placeholder: "請輸入你的回答",
